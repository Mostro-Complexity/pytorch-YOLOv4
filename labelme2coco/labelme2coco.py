...
from labelme2coco.annotation_utils import shape_conversion
...
class labelme2coco(object):
    ...
    def save_json(self):
        ...
        json.dump(self.data_coco, open(self.save_json_path, 'w', encoding='utf-8'), indent=4, ensure_ascii=False, separators=(',', ': '), cls=MyEncoder)
